...
def download_report():
    ...
    # QR Code
    elements.append(Paragraph("<b>Scan QR Code for Report Verification</b>", normal))
    elements.append(Spacer(1, 10))
    qr_image = Image(QR_PATH, width=1.2 * inch, height=1.2 * inch)
    elements.append(qr_image)
    elements.append(Spacer(1, 20))

    # Footer
    elements.append(Paragraph("<font color='grey'><b>Confidential Medical Report</b></font>", normal))
    elements.append(Paragraph("Generated by AI Healthcare Diagnosis Assistant", normal))
    elements.append(Paragraph("<b>Developed by Aggriya Anand</b>", normal))
